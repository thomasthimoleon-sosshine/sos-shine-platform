            ...
            <div className="flex items-center justify-center">
              <Link href="/" className="flex items-center gap-3">
                {logoUrl ? (
                  ...
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center font-display text-lg font-semibold" style={{ background: `linear-gradient(135deg, ${gold}, ${goldDeep})`, color: bg }}>S</div>
                )}
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center gap-10">
              <div className="flex items-center gap-3">
                ...
                <span className="font-display text-lg tracking-[0.15em]" style={{ color: gold }}>{foot.name || 'SOS Shine'}</span>
              </div>
