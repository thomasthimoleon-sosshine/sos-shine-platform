            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                style={{
                  ...
                  border: `1px solid ${createVisibility === 'rayons_only' ? 'rgba(201,169,97,0.3)' : 'var(--dark-border)'}`,
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {post.visibility === 'rayons_only' && (
                        <span className="text-[10px] font-medium px-2 py-0.5 rounded-full flex items-center gap-1"
                          style={{ background: 'rgba(201,169,97,0.1)', color: 'var(--gold)', border: '1px solid rgba(201,169,97,0.15)' }}>
