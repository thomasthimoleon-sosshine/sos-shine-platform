...
--
-- CGU/CGV : version en vigueur au 24 août 2026. Section 4 réécrite sur
-- l'offre réelle (abonnement unique 49,90 € + accès protocole 33 € avec
-- 30 jours d'accès découverte). Ni essai gratuit, ni formules Essentielle
-- et Premium, ni engagement 3/6/12 mois.
-- Politique de confidentialité : reprise mot pour mot du document fourni.
-- ═══════════════════════════════════════════════════════════════
...
<p>Version en vigueur au 24 août 2026</p>
...
<ul>
  ...
  <li>le choix d’une formule d’abonnement ou l’achat d’un protocole (voir section 4).</li>
</ul>
<p>L’utilisateur est responsable de la confidentialité de ses identifiants de connexion.</p>
<h2>4. Offre et tarifs</h2>
<h3>4.1 Abonnement à la plateforme</h3>
<p>SOS Shine® propose une formule d’abonnement unique, sans engagement de durée :</p>
<p><strong>Abonnement SOS Shine — 49,90 € TTC / mois</strong></p>
<p>Accès intégral à l’ensemble des contenus et fonctionnalités de la plateforme : encyclopédie des protocoles, Shine TV, Shine Shorts, Shine Audible, Shine Librairie, espaces communautaires, soins collectifs, lives et événements.</p>
<p>Aucune période d’essai gratuite n’est proposée. Le premier prélèvement intervient immédiatement après la souscription.</p>
<p>Les tarifs en vigueur sont disponibles sur la page tarifaire de la plateforme.</p>
<h3>4.2 Accès à un protocole seul</h3>
<p>Indépendamment de l’abonnement, l’utilisateur peut acheter l’accès à un protocole de son choix :</p>
<p><strong>Accès à un protocole — 33 € TTC, paiement unique</strong></p>
<p>Ce paiement unique débloque définitivement l’intégralité du protocole choisi, sans limitation de durée. Il ne s’agit pas d’un abonnement : aucun prélèvement ultérieur n’intervient, et il n’y a ni reconduction, ni résiliation à effectuer.</p>
<p>Cet achat ouvre en outre un accès découverte à l’ensemble de la plateforme pendant 30 jours, offert. À l’issue de ces 30 jours, l’accès aux autres contenus se ferme automatiquement, sans prélèvement ni démarche de la part de l’utilisateur, qui conserve le protocole acheté.</p>
<h3>4.3 Renouvellement et résiliation de l’abonnement</h3>
<p>L’abonnement mensuel est renouvelé automatiquement chaque mois. Il est sans engagement minimum de durée.</p>
...
<ul>
  ...
  <li>consent expressément à l’exécution immédiate du service numérique,</li>
  <li>renonce expressément à son droit de rétractation dès lors qu’il a accédé aux contenus.</li>
</ul>
<p>Aucune période d’essai gratuite n’étant proposée, l’utilisateur est invité à prendre connaissance du descriptif de l’offre avant toute souscription. L’étape 1 de chaque protocole reste librement accessible aux membres inscrits, sans frais, afin de permettre de découvrir la nature des contenus avant tout paiement.</p>
...
<ul>
  <li>l’utilisateur parrainé soit un nouveau membre (aucun compte existant),</li>
...
<p>SOS Shine® — CGU/CGV — Version en vigueur au 24 août 2026</p>'
  )
)
