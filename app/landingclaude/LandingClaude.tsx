...
const FAQ = [
  ...
  ['Combien ça coûte ensuite ?', "L'abonnement SOS Shine est à 49,90€/mois, sans engagement, et donne accès à tout. Tu peux aussi débloquer un seul protocole complet pour 33€."],
]
