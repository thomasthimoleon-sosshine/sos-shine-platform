...
const FAQ = [
  ...
  ['Combien coûte l\'abonnement ensuite ?', "29,90€/mois (7 jours offerts) pour tout débloquer. Ou 33€ en accès unique pour un protocole complet. Tu restes en gratuit aussi longtemps que tu veux."],
]
