...
const STEPS: Step[] = [
  ...
  { kind: 'question', id: 1, question: 'Quand tu souffres sans pouvoir le dire, qu\'est-ce que tu fais ?', choices: [
    { text: 'J\'analyse - comprendre aide à tenir' },
    { text: 'Je fais comme si tout allait bien' },
    { text: 'Je m\'effondre - les émotions débordent' },
    { text: 'Je m\'isole pour gérer seul(e)' },
    { text: 'Je me jette dans l\'action' },
  ]},
  { kind: 'question', id: 2, question: 'Ce qui t\'épuise le plus en ce moment ?', choices: [
    { text: 'Gérer les tensions et les conflits autour de moi' },
    { text: 'Toujours anticiper - être en alerte permanente' },
    { text: 'Ne pas contrôler ce qui se passe autour de moi' },
    { text: 'Tout porter seul(e) sans pouvoir demander de l\'aide' },
    { text: 'Avoir l\'impression que rien ne changera jamais' },
  ]},
  { kind: 'question', id: 3, multiMax: 2, question: 'Comment tu te retrouves souvent dans tes relations ?', choices: [
    { text: 'À fuir quand c\'est trop intense' },
    { text: 'À éviter les conflits même si j\'ai raison' },
    { text: 'À analyser les autres pour les comprendre vraiment' },
    { text: 'À m\'occuper constamment pour ne pas penser' },
    { text: 'À ressentir les émotions des autres comme les miennes' },
    { text: 'À réagir fort sur le moment, puis à regretter' },
    { text: 'À m\'adapter au point de me perdre moi-même' },
  ]},
  ...
  { kind: 'question', id: 4, question: 'Tu es en conflit avec quelqu\'un. Comment tu gères ?', choices: [
    { text: 'Je cède pour que ça s\'arrête' },
    { text: 'Je cherche la solution logique qui arrange tout le monde' },
    { text: 'Je réagis fort sur le moment, puis je regrette' },
    { text: 'Je disparais - mentalement ou physiquement' },
    { text: 'Je prends soin de l\'autre même si c\'est moi qui suis blessé(e)' },
  ]},
  { kind: 'question', id: 5, multiMax: 2, question: 'Qu\'est-ce qui déclenche ton stress ?', choices: [
    { text: 'Sentir que quelqu\'un est déçu de moi' },
    { text: 'Les conflits et les tensions autour de moi' },
    { text: 'L\'incertitude - ne pas savoir ce qui va se passer' },
    { text: 'Devoir dire non ou décevoir les autres' },
    { text: 'Perdre le contrôle d\'une situation' },
    { text: 'Être jugé(e) ou critiqué(e)' },
  ]},
  ...
  { kind: 'question', id: 6, question: 'Ce qui te pèse le plus ?', choices: [
    { text: 'Me sentir seul(e) même quand je suis entouré(e)' },
    { text: 'Ne jamais vraiment me détendre - toujours en tension' },
    { text: 'Ne pas être à la hauteur de ce que je pourrais être' },
    { text: 'Ne jamais savoir si je fais les bons choix' },
    { text: 'Devoir toujours m\'adapter aux attentes des autres' },
  ]},
  { kind: 'question', id: 7, question: 'Ce qui t\'empêche d\'avancer ?', choices: [
    { text: 'La peur de mal faire - je préfère ne pas commencer' },
    { text: 'La conviction que je dois y arriver seul(e)' },
    { text: 'Je m\'épuise en action pour ne pas avoir à ressentir' },
    { text: 'L\'intensité de ce que je ressens me paralyse' },
    { text: 'Une peur sous-jacente que je ne sais pas nommer' },
    { text: 'Le regard et le jugement des autres' },
  ]},
  { kind: 'question', id: 8, question: 'Quand tout s\'effondre, tu…', choices: [
    { text: 'Tu t\'isoles et tu gères seul(e)' },
    { text: 'Tu analyses tout pour comprendre' },
    { text: 'Tu imagines le pire - scénarios catastrophes' },
    { text: 'Tu reprends le contrôle - listes, action, organisation' },
    { text: 'Tu lâches tout - les émotions te submergent' },
    { text: 'Tu fais comme si rien n\'était - tu souris pour les autres' },
  ]},
  { kind: 'question', id: 9, question: 'Qu\'est-ce qui te fait te sentir vivant(e) ?', choices: [
    { text: 'Comprendre quelque chose en profondeur' },
    { text: 'Être vraiment utile pour quelqu\'un' },
    { text: 'Avoir tout planifié et maîtrisé' },
    { text: 'Être reconnu(e) et apprécié(e) pour ce que je fais' },
    { text: 'Réussir quelque chose par mes propres moyens' },
    { text: 'Les moments d\'intensité - être pleinement présent(e)' },
  ]},
  { kind: 'question', id: 10, question: 'Ce que tu évites le plus ?', choices: [
    { text: 'Perdre le contrôle de toi-même ou d\'une situation' },
    { text: 'Décevoir les personnes que tu aimes' },
    { text: 'Ne pas comprendre ce qui se passe vraiment' },
    { text: 'Paraître faible ou dans le besoin' },
    { text: 'Rester immobile - tu préfères l\'action même inutile' },
    { text: 'Ne pas être à la hauteur de l\'image que les autres ont de toi' },
  ]},
  ...
  { kind: 'question', id: 11, question: 'Comment tu vis tes émotions ?', choices: [
    { text: 'Je les garde pour moi - les exprimer me rend vulnérable' },
    { text: 'J\'analyse avant de ressentir' },
    { text: 'Je les transforme en énergie - je bouge, j\'agis' },
    { text: 'Les émotions des autres passent avant les miennes' },
    { text: 'Je les contrôle - montrer ses émotions c\'est perdre le contrôle' },
    { text: 'Tout ou rien - jamais dans la nuance' },
  ]},
  { kind: 'question', id: 12, question: 'Ce que tu attends des autres ?', choices: [
    { text: 'Qu\'ils respectent mon espace et mes limites' },
    { text: 'Qu\'ils n\'attendent pas trop de moi' },
    { text: 'Qu\'il n\'y ait pas de conflits ni de tensions' },
    { text: 'Qu\'ils me laissent gérer à ma façon' },
    { text: 'Qu\'ils me voient tel(le) que je suis vraiment' },
    { text: 'Qu\'ils soient là dans les moments qui comptent' },
  ]},
  { kind: 'question', id: 13, question: 'Comment tu prends tes décisions ?', choices: [
    { text: 'J\'attends d\'être sûr(e) - décider trop vite m\'angoisse' },
    { text: 'Je décide vite et fort même si ça choque' },
    { text: 'Je consulte tout le monde pour ne froisser personne' },
    { text: 'J\'anticipe tous les risques avant de me lancer' },
    { text: 'Je décide seul(e) - les avis me compliquent' },
    { text: 'J\'analyse longtemps pour la solution parfaite' },
  ]},
  { kind: 'question', id: 14, question: 'Ce que tu gardes pour toi ?', choices: [
    { text: 'Tes rêves les plus fous' },
    { text: 'Tes peurs les plus profondes' },
    { text: 'Tes vraies opinions - pour éviter les conflits' },
    { text: 'Tes blessures passées - tu préfères ne pas les rouvrir' },
    { text: 'L\'intensité de ce que tu ressens' },
    { text: 'À quel point tu portes les autres' },
  ]},
  { kind: 'question', id: 15, question: 'Ce qui te ressemble le plus ?', choices: [
    { text: 'Comprendre les choses en profondeur - la vérité avant tout' },
    { text: 'Être toujours prêt(e) - anticiper pour ne jamais être pris(e) au dépourvu' },
    { text: 'Prendre soin des autres - même en t\'oubliant' },
    { text: 'Maîtriser ta vie - chaque détail, chaque plan' },
    { text: 'T\'adapter à tout et à tous' },
    { text: 'Ressentir fort - les hauts très hauts, les bas très bas' },
  ]},
