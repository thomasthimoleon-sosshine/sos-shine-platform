...
const SAMPLE_REVIEWS: Review[] = [
  ...
  { id: 'r3', author: 'Camille D.', avatar: '', rating: 5, text: 'Le meilleur guide que j\'ai trouvé sur le sujet. Merci SOS Shine !', date: '4 mars 2026' },
  { id: 'r4', author: 'Léa M.', avatar: '', rating: 4, text: 'Les illustrations sont magnifiques et le contenu est riche. Un vrai bijou.', date: '1 mars 2026' },
  { id: 'r5', author: 'Nadia B.', avatar: '', rating: 5, text: 'J\'ai offert ce livre à ma meilleure amie. On en parle ensemble chaque semaine.', date: '27 fév 2026' },
]
    ...
    return (
      <div className="min-h-[80vh] flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <p className="font-display text-xl font-semibold" style={{ color: 'var(--gold)' }}>Shine Librairie</p>
            ...
            <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide" style={{ scrollbarWidth: 'none' }}>
              {CONTENT_TYPES.map(ct => (
                <button
                  ...
                  style={{
                    background: activeType === ct.id ? 'var(--gold)' : 'rgba(255,255,255,0.06)',
                    color: activeType === ct.id ? '#09090b' : 'var(--text-secondary)',
                    border: activeType === ct.id ? 'none' : '1px solid var(--dark-border)',
                  }}
                >
                  {ct.icon} {ct.label}
                </button>
