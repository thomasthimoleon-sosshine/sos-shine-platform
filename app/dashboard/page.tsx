...
export default function DashboardHome() {
  ...
  const quickAccess = [
    ...
    },
    {
      href: '/dashboard/chat',
      title: 'Chat Général',
      description: 'Échangez librement avec la communauté.',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    },
    {
      ...
      description: 'Annonces, publications et partages.',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    },
    {
      ...
      title: 'Événements',
      description: 'Soins collectifs, ateliers, lives et Shine Walks à venir.',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  const steps = [
    { num: '01', title: 'Comprendre', desc: 'Vidéo de coaching immersive', accent: '#55EFC4' },
    { num: '02', title: 'Libération', desc: 'Soin énergétique', accent: '#74C0FC' },
    { num: '03', title: 'Méditation', desc: 'Intégration & reconnexion', accent: '#E17055' },
    { num: '04', title: 'Action', desc: 'Exercices & reprogrammation', accent: '#D4AF37' },
  ]
    ...
    <div className="max-w-5xl mx-auto space-y-10">
      ...
      >
        ...
        <h1 className="font-display text-3xl sm:text-4xl font-semibold tracking-tight" style={{ color: 'var(--text-primary)' }}>
          Bienvenue, <span style={{ color: 'var(--gold)' }}>{profile?.prenom || 'Membre'}</span>
        </h1>
