...
const _LEGACY_TOPICS_REMOVED = [
  ...
  { letter: "A", title: "Ayurveda", subtitle: "médecine ancienne, connaissance des doshas, équilibre naturel", cat: "Approches & Méthodes" },
  // B
  ...
  { letter: "B", title: "Breathwork", subtitle: "respiration consciente et holotropique comme outil de guérison", cat: "Approches & Méthodes" },
  ...
  { letter: "C", title: "Cristaux & lithothérapie", subtitle: "propriétés vibratoires des pierres et usage thérapeutique", cat: "Approches & Méthodes" },
  ...
  // D
  { letter: "D", title: "Danse-thérapie", subtitle: "le mouvement du corps comme langage de guérison", cat: "Approches & Méthodes" },
  ...
  { letter: "E", title: "EMDR", subtitle: "thérapie par les mouvements oculaires pour traiter les traumatismes", cat: "Approches & Méthodes" },
  ...
  { letter: "H", title: "Hypnose thérapeutique", subtitle: "travail sur l'inconscient par l'hypnose et la transe", cat: "Approches & Méthodes" },
  // I
  ...
  { letter: "M", title: "Médecine ayurvédique", subtitle: "connaissance de soi par les doshas et l'harmonie naturelle", cat: "Approches & Méthodes" },
  { letter: "M", title: "Médecine traditionnelle chinoise", subtitle: "MTC - méridiens, énergie, organes et émotions", cat: "Approches & Méthodes" },
  ...
  { letter: "S", title: "Son & vibrations", subtitle: "sound healing, bols tibétains, mantras, guérison par le son", cat: "Approches & Méthodes" },
