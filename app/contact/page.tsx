  ...
  return (
    <main className="min-h-screen px-6 py-16 bg-[var(--surface)]">
      <div className="max-w-3xl mx-auto">
        <Link href="/" className="inline-flex items-center gap-2 text-sm mb-8 transition-colors text-[var(--text-muted)]">
        ...
        <div className="rounded-2xl p-8 space-y-6" style={{ background: 'var(--surface-card)', border: '1px solid var(--border)' }}>
          {/* Email */}
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0" style={{ background: 'rgba(201,169,97,0.1)' }}>
            ...
            <div>
              <p className="text-xs font-medium uppercase tracking-wider mb-1 text-[var(--text-muted)]">Email</p>
              <a href={`mailto:${email}`} className="text-sm hover:underline text-[var(--brand)]">{email}</a>
            </div>
          </div>
          ...
          {phone && (
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-xs font-medium uppercase tracking-wider mb-1 text-[var(--text-muted)]">{t('contact.phone')}</p>
                <a href={`tel:${phone}`} className="text-sm hover:underline text-[var(--brand)]">{phone}</a>
              </div>
            </div>
          )}
          ...
          {address && (
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-xs font-medium uppercase tracking-wider mb-1 text-[var(--text-muted)]">{t('contact.address')}</p>
                <p className="text-sm whitespace-pre-line text-[var(--text-secondary)]">{address}</p>
              </div>
            </div>
          )}
        </div>
        ...
        {content && (
          <div
            className="prose prose-invert max-w-none text-sm leading-relaxed space-y-4 mt-8 text-[var(--text-secondary)]"
