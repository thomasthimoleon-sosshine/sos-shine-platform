...
export const STRIPE_PRICES: Record<string, string> = {
  essential_monthly:    process.env.STRIPE_PRICE_ESSENTIAL_MONTHLY || 'price_1TAwx903aEbW4K6eeoRj1Ejo',
  ...
  premium_monthly:      process.env.STRIPE_PRICE_PREMIUM_MONTHLY || 'price_1TAx2s03aEbW4K6eH4SL0Qno',
