    ...
    <div className="max-w-5xl mx-auto space-y-4">
      ...
      {showNewSection && (
        <div className="rounded-xl p-5 space-y-4"
          style={{ background: 'var(--surface-card)', border: '1px solid #A78BFA40' }}>
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-3">
              <button type="button" onClick={() => setNewSectionType('normal')}
                ...
                style={{
                  ...
                  border: `1px solid ${newSectionType === 'normal' ? '#A78BFA' : 'var(--border)'}`,
                }}>
              ...
              <button type="button" onClick={() => setNewSectionType('html')}
                ...
                style={{
                  ...
                  border: `1px solid ${newSectionType === 'html' ? '#A78BFA' : 'var(--border)'}`,
                }}>
