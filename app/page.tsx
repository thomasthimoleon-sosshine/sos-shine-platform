      ...
      {vis('footer') && (
        <footer className="relative overflow-hidden" style={{ background: "linear-gradient(180deg, rgba(0,0,0,0.2) 0%, rgba(0,0,0,0.6) 100%)" }}>
          ...
          <div className="border-t border-[var(--dark-border)]">
            <div className="max-w-7xl mx-auto px-5 md:px-20 pt-16 md:pt-28 pb-12 md:pb-20">

              <RevealOnScroll>
                <p className="luxury-title text-center text-[10px] sm:text-xs tracking-[0.4em] sm:tracking-[0.5em] text-[var(--text-muted)] mb-3 md:mb-4">Notre Histoire</p>
              </RevealOnScroll>
              <RevealOnScroll delay={0.1}>
                <h2 className="font-display font-light text-center text-2xl sm:text-3xl md:text-5xl lg:text-6xl mb-6 md:mb-8" style={{ color: 'var(--gold)' }}>
                  <WordByWordReveal text="Trois forces. Une seule mission." />
                </h2>
              </RevealOnScroll>
              <RevealOnScroll delay={0.2}>
                <p className="text-center text-[var(--text-secondary)] max-w-3xl mx-auto text-sm sm:text-base md:text-lg leading-relaxed font-light mb-12 md:mb-20">
              ...
              <div className="relative max-w-5xl mx-auto">
                ...
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-[0.04]">
                  <svg viewBox="0 0 400 350" className="w-[280px] h-[245px] md:w-[400px] md:h-[350px]" fill="none" stroke="var(--gold)" strokeWidth="0.5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 relative z-10">
                  ...
                  <RevealOnScroll delay={0.3} direction="left">
                    <div className="group relative">
                      <div className="glow-card p-6 sm:p-8 md:p-10 text-center h-full flex flex-col items-center" style={{ '--glow-color': 'rgba(212, 175, 55, 0.08)' } as React.CSSProperties}>
                        {/* Triangle icon */}
                        <div className="w-14 h-14 sm:w-16 sm:h-16 mb-5 md:mb-6 relative flex items-center justify-center">
                          <svg viewBox="0 0 60 55" className="w-full h-full trinity-triangle trinity-energy" fill="none" stroke="var(--gold)" strokeWidth="1.5">
                            <polygon points="30,5 55,50 5,50" className="transition-all duration-700 group-hover:fill-[rgba(212,175,55,0.1)]" />
                          </svg>
                          <span className="absolute inset-0 flex items-center justify-center text-lg md:text-xl mt-1" style={{ color: 'var(--gold)' }}>&#9829;</span>
                        </div>
                        <p className="luxury-title text-[10px] sm:text-xs tracking-[0.3em] text-[var(--gold)] mb-2 opacity-70">Fondatrice</p>
                        <h3 className="font-display text-xl sm:text-2xl md:text-3xl mb-2" style={{ color: 'var(--gold)' }}>Julia</h3>
                        <p className="luxury-title text-[10px] sm:text-xs tracking-[0.25em] text-[var(--text-muted)] mb-4 md:mb-5">Le Pilier Énergétique</p>
                        <div className="w-8 h-[1px] mx-auto mb-4 md:mb-5" style={{ background: 'linear-gradient(90deg, transparent, var(--gold), transparent)' }} />
                  ...
                  <RevealOnScroll delay={0.45} direction="up">
                    <div className="group relative">
                      <div className="glow-card p-6 sm:p-8 md:p-10 text-center h-full flex flex-col items-center" style={{ '--glow-color': 'rgba(212, 175, 55, 0.08)' } as React.CSSProperties}>
                        <div className="w-14 h-14 sm:w-16 sm:h-16 mb-5 md:mb-6 relative flex items-center justify-center">
                          <svg viewBox="0 0 60 55" className="w-full h-full trinity-triangle trinity-body" fill="none" stroke="var(--gold)" strokeWidth="1.5">
                            <polygon points="30,5 55,50 5,50" className="transition-all duration-700 group-hover:fill-[rgba(212,175,55,0.1)]" />
                          </svg>
                          <span className="absolute inset-0 flex items-center justify-center text-lg md:text-xl mt-1" style={{ color: 'var(--gold)' }}>&#9878;</span>
                        </div>
                        <p className="luxury-title text-[10px] sm:text-xs tracking-[0.3em] text-[var(--gold)] mb-2 opacity-70">Cofondateur</p>
                        <h3 className="font-display text-xl sm:text-2xl md:text-3xl mb-2" style={{ color: 'var(--gold)' }}>William</h3>
                        <p className="luxury-title text-[10px] sm:text-xs tracking-[0.25em] text-[var(--text-muted)] mb-4 md:mb-5">Le Pilier Corporel</p>
                        <div className="w-8 h-[1px] mx-auto mb-4 md:mb-5" style={{ background: 'linear-gradient(90deg, transparent, var(--gold), transparent)' }} />
                        <p className="text-[var(--text-secondary)] text-xs sm:text-sm leading-relaxed font-light">
                  ...
                  <RevealOnScroll delay={0.6} direction="right">
                    <div className="group relative">
                      <div className="glow-card p-6 sm:p-8 md:p-10 text-center h-full flex flex-col items-center" style={{ '--glow-color': 'rgba(212, 175, 55, 0.08)' } as React.CSSProperties}>
                        <div className="w-14 h-14 sm:w-16 sm:h-16 mb-5 md:mb-6 relative flex items-center justify-center">
                          <svg viewBox="0 0 60 55" className="w-full h-full trinity-triangle trinity-mind" fill="none" stroke="var(--gold)" strokeWidth="1.5">
                            <polygon points="30,5 55,50 5,50" className="transition-all duration-700 group-hover:fill-[rgba(212,175,55,0.1)]" />
                          </svg>
                          <span className="absolute inset-0 flex items-center justify-center text-lg md:text-xl mt-1" style={{ color: 'var(--gold)' }}>&#10023;</span>
                        </div>
                        <p className="luxury-title text-[10px] sm:text-xs tracking-[0.3em] text-[var(--gold)] mb-2 opacity-70">Cofondateur</p>
                        <h3 className="font-display text-xl sm:text-2xl md:text-3xl mb-2" style={{ color: 'var(--gold)' }}>Thomas</h3>
                        <p className="luxury-title text-[10px] sm:text-xs tracking-[0.25em] text-[var(--text-muted)] mb-4 md:mb-5">Le Pilier Mental</p>
                        <div className="w-8 h-[1px] mx-auto mb-4 md:mb-5" style={{ background: 'linear-gradient(90deg, transparent, var(--gold), transparent)' }} />
                        <p className="text-[var(--text-secondary)] text-xs sm:text-sm leading-relaxed font-light">
                ...
                <RevealOnScroll delay={0.8}>
                  <div className="mt-10 md:mt-16 text-center">
                    <div className="inline-flex items-center gap-3 sm:gap-4 md:gap-6">
                      <div className="w-8 sm:w-12 md:w-16 h-[1px]" style={{ background: 'linear-gradient(90deg, transparent, var(--gold))' }} />
                      <p className="luxury-title text-[10px] sm:text-xs tracking-[0.3em] sm:tracking-[0.4em] text-[var(--text-muted)]">
                        Énergie &middot; Corps &middot; Mental
                      </p>
                      <div className="w-8 sm:w-12 md:w-16 h-[1px]" style={{ background: 'linear-gradient(90deg, var(--gold), transparent)' }} />
                    </div>
                    <p className="text-[var(--text-secondary)] max-w-2xl mx-auto mt-4 md:mt-6 text-xs sm:text-sm md:text-base leading-relaxed font-light">
