...
export const LANDING_DEFAULTS: LandingSectionDefault[] = [
  ...
  },
  {
    ...
    content: {
      ...
      pricing_plans: [
        { name: 'ACCÈS', price: '9,90', period: '/mois', description: 'Pour explorer à votre rythme.', features: ['Encyclopédie complète', '200+ protocoles guidés', 'Communauté, Audible et Feu de Camp'], button_label: 'Commencer, 7 jours gratuits', button_href: '/signup', highlight: false, badge: '' },
        { name: 'ENGAGEMENT', price: '49,90', period: '/mois', description: 'Pour ceux qui veulent vraiment transformer quelque chose.', features: ["Tout de l'Accès", 'Lives hebdomadaires avec Julia', 'Événements collectifs', 'Soin collectif mensuel', 'Shine TV, Shine Audible, Shine Journal', 'Shine Shorts et contenus exclusifs'], button_label: 'Commencer, 7 jours gratuits', button_href: '/signup', highlight: true, badge: 'POPULAIRE' },
      ],
      ...
      cta_details: '9,90\u20ac/mois \u00b7 Sans engagement \u00b7 7 jours gratuits \u00b7 Tout inclus',
    },
    styles: {},
  },
]
