...
interface SubscriptionGateProps {
  ...
  /** Optional: text shown in the loading state */
  loadingText?: string
}

/**
 * Wraps content pages that require an active subscription.
 * - If the user has an active sub (or is admin), renders children normally.
 * - If not, shows a "Réservé aux membres abonnés" overlay with CTA to /dashboard/tarifs.
 */
