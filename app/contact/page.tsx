        ...
        <div className="rounded-2xl p-8 space-y-6" style={{ background: 'var(--surface-card)', border: '1px solid var(--border)' }}>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <a href={`mailto:${email}`} className="text-sm hover:underline" style={{ color: 'var(--brand)' }}>{email}</a>
            </div>
          </div>
          ...
          {phone && (
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href={`tel:${phone}`} className="text-sm hover:underline" style={{ color: 'var(--brand)' }}>{phone}</a>
              </div>
            </div>
          )}
