      ...
      <div className="flex items-start justify-between gap-4">
        ...
        {isBanned ? (
          ...
          <button
            ...
            style={{
              background: showCreate ? 'rgba(201,169,97,0.1)' : 'linear-gradient(135deg, var(--gold), #B8960F)',
              color: showCreate ? 'var(--gold)' : '#000000',
        ...
        <div className="rounded-2xl p-6 space-y-5" style={{ background: 'var(--dark-card)', border: '1px solid var(--dark-border)' }}>
              ...
              {([
                ...
                <button
                  ...
                  style={{
                    ...
                    border: `1px solid ${createMediaType === mt.value ? 'rgba(201,169,97,0.3)' : 'var(--dark-border)'}`,
          ...
          <div className="flex justify-end">
            <button
              ...
              style={{ background: 'linear-gradient(135deg, var(--gold), #B8960F)', color: '#000000' }}
            >
          ...
          {filterOpen && (
            <div className="absolute top-full left-0 right-0 mt-1 rounded-xl py-1 z-30 shadow-xl"
              ...
              <button
                ...
                style={{ color: filterCategory === 'all' ? 'var(--gold)' : 'var(--text-secondary)', background: filterCategory === 'all' ? 'rgba(201,169,97,0.08)' : 'transparent' }}
              >
                  ...
                  <Link href={`/dashboard/membre/${post.author_id}`} className="flex items-center gap-2.5 mb-4 hover:opacity-80 transition-opacity">
                    ...
                    <div>
                      ...
                      {post.profiles?.role === 'founder' && (
                        <span className="text-xs ml-2 px-1.5 py-0.5 rounded" style={{ background: 'rgba(201,169,97,0.15)', color: 'var(--gold)' }}>
                          Fondateur
                        </span>
                      )}
                    </div>
