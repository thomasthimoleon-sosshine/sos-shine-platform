...
export default function ReserveForm({ ctaLabel, stripeUrl, isFree, eventId, eventTitle, eventDate, eventLocation }: { ctaLabel: string; stripeUrl: string | null; isFree?: boolean; eventId?: string; eventTitle?: string; eventDate?: string; eventLocation?: string }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const res = await fetch('/api/ceremonie/reserve', {
      ...
      body: JSON.stringify({ prenom, nom, email, _hp: hp, isFree, eventId, eventTitle, eventDate, eventLocation }),
    })
