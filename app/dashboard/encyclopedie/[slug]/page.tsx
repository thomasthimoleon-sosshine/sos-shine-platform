      ...
      <div className="rounded-2xl p-6 sm:p-8" style={{ background: `${currentStep.color}06`, border: `1px solid ${currentStep.color}15` }}>
        ...
        {(() => {
          ...
          if (currentStep.contentType === 'audio_energy') {
            return contentUrl ? (
              <div className="rounded-xl overflow-hidden mb-4 p-4" style={{ background: 'var(--dark)' }}>
                <p className="font-medium text-sm mb-2" style={{ color: 'var(--text-primary)' }}>Audio de libération</p>
