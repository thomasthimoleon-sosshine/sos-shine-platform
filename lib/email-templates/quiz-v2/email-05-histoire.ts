...
export function generateEmail05(vars: Vars): { subject: string; html: string } {
  ...
  const content = [
    ...
    p(`Il faut aussi de l'amour pour soi, mais ça, je t'en parlerai demain. C'est tout un sujet, et il mérite qu'on s'y attarde vraiment. Et je t'offrirai quelque chose avec.`),
