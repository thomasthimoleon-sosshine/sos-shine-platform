    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      >
        <div className="flex items-start gap-5">
          {/* Avatar */}
          <div
            className="w-16 h-16 rounded-2xl flex items-center justify-center text-2xl font-display font-semibold flex-shrink-0"
            ...
            {editing ? (
              ...
              <div>
                ...
                <button
                  ...
                  className="mt-3 text-xs font-medium cursor-pointer transition-colors"
        ...
        {subscription ? (
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span
                ...
                style={{
                  background: `${getStatusLabel(subscription.status).color}15`,
          ...
          >
            ...
            <p className="text-xs mb-4" style={{ color: 'var(--text-secondary)' }}>
              Puis 29€/mois — annulable à tout moment
            </p>
            <span
              className="text-xs font-medium"
              style={{ color: 'var(--gold)' }}
            >
              Le paiement Stripe sera bientôt activé
            </span>
          </div>
        )}
      </div>
      ...
      <div className="text-center py-4">
        <p className="text-xs" style={{ color: 'var(--text-muted)' }}>
          Une question ? <span style={{ color: 'var(--gold)' }}>contact@sosshine.fr</span>
        </p>
      </div>
    </div>
  )
