...
const FAQ_DATA: { keywords: string[]; answer: string }[] = [
  {
    ...
    answer: "L'abonnement SOS Shine est à 49,90€/mois et donne accès à tout : encyclopédie, Shine TV, Shorts, Audible, Librairie, communauté, événements, soins collectifs et lives. Les étapes 2 & 3 de votre protocole recommandé sont également disponibles en accès unique à 33€. 💎",
  },
  {
