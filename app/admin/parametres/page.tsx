...
const sections: SectionDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { label: 'Features Essentiel (une par ligne)', key: 'features_essential', type: 'textarea', default: "Encyclopédie complète des expériences de vie\n3 étapes par challenge émotionnel\nChat dédié + Chat général\nMur communautaire\nSoins collectifs & événements\nEssai gratuit 7 jours" },
