-- ════════════════════════════════════════════════════════════════════
-- SOS Meet Couple « Se retrouver »
-- Dix tables, RLS fermée partout : tout accès passe par les routes
-- serveur en service-role, qui authentifient d'abord l'utilisateur.
-- Ne touche à aucune table du parcours solo.
-- Voir docs/ARCHITECTURE-SOS-MEET-COUPLE.md
-- ════════════════════════════════════════════════════════════════════
