...
const sections: SectionDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { label: 'Titre', key: 'principe_title', type: 'textarea', default: "On ne change pas votre identité. On éteint la douleur pour libérer votre potentiel." },
      { label: 'Description', key: 'principe_desc', type: 'textarea', default: "Chaque douleur — abandon, trahison, burn-out, deuil, peur — possède sa propre page dans notre encyclopédie, avec un protocole en 4 étapes conçu pour vous accompagner de A à Z." },
      sep('Style & mise en page'),
  ...
  },
  {
    ...
    fields: [
      ...
      { label: 'Titre de section', key: 'steps_title', type: 'text', default: '4 étapes pour chaque douleur' },
  ...
  },
  {
    ...
    fields: [
      { label: 'Titre de section', key: 'encyclo_title', type: 'text', default: 'Chaque douleur a sa page dédiée' },
      { label: 'Description', key: 'encyclo_desc', type: 'textarea', default: "Abandon, trahison, burn-out, deuil, dépendance affective, peur, solitude, rejet... Classées de A à Z." },
      { label: 'Douleurs affichées (une par ligne)', key: 'encyclo_items', type: 'textarea', default: "Abandon\nAnxiété\nBurn-out\nDépendance affective\nDeuil\nManque de confiance\nPeur\nRejet\nRupture\nSolitude\nTrahison\nEt plus..." },
      sep('Style'),
  ...
  },
  {
    ...
    fields: [
      ...
      { label: 'Description', key: 'community_desc', type: 'textarea', default: "Chat dédié par douleur, chat général, mur communautaire, soins collectifs et événements — une vraie famille." },
      { label: 'Bloc 1 — Titre', key: 'community_block1_title', type: 'text', default: 'Le Feu de Camp' },
      { label: 'Bloc 1 — Description', key: 'community_block1_desc', type: 'textarea', default: "Chaque douleur a son propre chat. Échangez avec ceux qui comprennent vraiment." },
  ...
  },
  {
    ...
    fields: [
      ...
      { label: 'Témoignage 4', key: 'testimonial_4', type: 'textarea', default: "Grâce aux 4 étapes, j'ai compris ma douleur au lieu de la fuir.|Antoine, 37 ans|Genève" },
      sep('Style'),
  ...
  },
  {
    ...
    fields: [
      ...
      { label: 'Features Essentiel (une par ligne)', key: 'features_essential', type: 'textarea', default: "Encyclopédie complète des douleurs\n4 étapes par douleur\nChat dédié + Chat général\nMur communautaire\nSoins collectifs & événements\nEssai gratuit 7 jours" },
